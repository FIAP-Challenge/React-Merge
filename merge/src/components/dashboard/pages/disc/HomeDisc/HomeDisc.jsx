...
import ResultDisc from "../ResultDisc";
import { AuthContext } from "../../../../../AuthContext";
import GraphResult from "./ResultDisc/GraphResult";
import ButtonInfos from "../../../../Templates/buttonInfos/ButtonInfos";
import TableDisc from "../TableDiscInfos/TableDisc";
const HomeDisc = () => {
                    ...
                    <div className="containerHomeDiscMaster">
                        ...
                        {goSteps === 0 && (
                            <div className="containerHomeDisc">
                                <div className="align-items-disc">


                                </div>
                                <div className="headerTitle">
                                    <h1>Métolodologia disc</h1>
                                </div>
                                <div className="body">
                                    <div>
                ...
                (
                    <div className="containerHomeDiscMaster">
                        ...
                        <div className="containerHomeDisc">
                            ...
                            <div>
                                <GraphResult disc={candidato.disc} />
                            </div>
