...
import Noticias from '../dashboard/pages/noticias/Noticias'
  ...
  return (
    ...
    <>
      <Routes>
        ...
        <Route path="/dashboard/noticias" element={<ProtectedRoute user={isAuth()}> <Dashboard /> <Noticias/></ProtectedRoute>} />
